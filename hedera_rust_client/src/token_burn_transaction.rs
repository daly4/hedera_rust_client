...
#[hedera_rust_client_derive(service(method_service_name = "token", method_service_fn = "burn_token"))]
...
#[hedera_rust_client_derive(proto(proto_enum = "TokenBurn", proto_type = "TokenBurnTransactionBody"))]
struct Proto {
